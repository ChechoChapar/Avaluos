CREATE TABLE PGB_HIST_AVALUOS
(
  SECUENCIA_HISTORICO     NUMBER(10)            NOT NULL,
  ID_AVALUO               NUMBER                NOT NULL,
  N_CONSECUTIVOBANCO      NUMBER                NOT NULL,
  C_IDTIPOIDENTIFICACION  NUMBER                NOT NULL,
  N_IDENTIFICACION        NUMBER                NOT NULL,
  ...
  A_CODDANE_DEPTO         NUMBER(13),
  A_CODDANE_CIUDAD        NUMBER(13),
