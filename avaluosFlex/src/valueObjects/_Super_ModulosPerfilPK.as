 ...
 * of this value object you may modify the generated sub-class of this class - ModulosPerfilPK.as.
 */
...
[ExcludeClass]
public class _Super_ModulosPerfilPK extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.segurosbolivar.plantillaSeguridad.entities.ModulosPerfilPK") == null)
            {
                flash.net.registerClassAlias("com.segurosbolivar.plantillaSeguridad.entities.ModulosPerfilPK", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ModulosPerfilPKEntityMetadata;
    ...
    public function _Super_ModulosPerfilPK()
    {
        _model = new _ModulosPerfilPKEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ModulosPerfilPKEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ModulosPerfilPKEntityMetadata) : void
    {
        var oldValue : _ModulosPerfilPKEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
