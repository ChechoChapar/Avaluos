 ...
 * of this service wrapper you may modify the generated sub-class of this class - ObservacionesService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_ObservacionesService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_ObservacionesService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "create");
         operation.resultType = valueObjects.Observaciones;
        ...
        destination = "ObservacionesService";
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function create(arg0:valueObjects.Observaciones) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function update(arg0:valueObjects.Observaciones) : mx.rpc.AsyncToken
    {
