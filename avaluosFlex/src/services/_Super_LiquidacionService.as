 ...
 * of this service wrapper you may modify the generated sub-class of this class - LiquidacionService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_LiquidacionService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_LiquidacionService()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.LiquidacionAvaluo._initRemoteClassAlias();
        ...
        operation = new mx.rpc.remoting.Operation(null, "update");
         operation.resultElementType = valueObjects.LiquidacionAvaluo;
        ...
        destination = "LiquidacionService";
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function update(arg0:ArrayCollection) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function create(arg0:ArrayCollection) : mx.rpc.AsyncToken
    {
