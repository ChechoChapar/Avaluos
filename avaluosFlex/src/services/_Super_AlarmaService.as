 ...
 * of this service wrapper you may modify the generated sub-class of this class - AlarmaService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_AlarmaService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_AlarmaService()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.Alarma._initRemoteClassAlias();

        var operations:Object = new Object();
        var operation:mx.rpc.remoting.Operation;

        operation = new mx.rpc.remoting.Operation(null, "retornaAlarma");
         operation.resultType = String;
        operations["retornaAlarma"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "main");
        operations["main"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "consultaAlarmas");
         operation.resultElementType = valueObjects.Alarma;
        operations["consultaAlarmas"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "persist");
        operations["persist"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "guardaAlarma");
        operations["guardaAlarma"] = operation;
    ...
    /**
      * This method is a generated wrapper used to call the 'retornaAlarma' operation. It returns an mx.rpc.AsyncToken whose 
      ...
      */
    public function retornaAlarma() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("retornaAlarma");
    ...
    /**
      * This method is a generated wrapper used to call the 'consultaAlarmas' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function consultaAlarmas() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("consultaAlarmas");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send() ;
    ...
    /**
      * This method is a generated wrapper used to call the 'guardaAlarma' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function guardaAlarma(arg0:valueObjects.Alarma) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("guardaAlarma");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
