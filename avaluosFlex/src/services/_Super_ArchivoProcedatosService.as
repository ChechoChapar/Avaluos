 ...
 * of this service wrapper you may modify the generated sub-class of this class - ArchivoProcedatosService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_ArchivoProcedatosService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_ArchivoProcedatosService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getAvaluos");
         operation.resultElementType = valueObjects.Avaluo;
        operations["getAvaluos"] = operation;
        ...
        destination = "ArchivoProcedatosService";
    ...
    /**
      * This method is a generated wrapper used to call the 'getAvaluos' operation. It returns an mx.rpc.AsyncToken whose 
      ...
      */
    public function getAvaluos(arg0:Date) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getAvaluos");
