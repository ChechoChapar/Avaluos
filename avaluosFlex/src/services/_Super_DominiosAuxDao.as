 ...
 * of this service wrapper you may modify the generated sub-class of this class - DominiosAuxDao.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_DominiosAuxDao extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{      
       
    // Constructor
    public function _Super_DominiosAuxDao()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getValoresDescLiquidacion");
		 operation.resultElementType = valueObjects.DominiosAux;
        operations["getValoresDescLiquidacion"] = operation;

        valueObjects.DominiosAux._initRemoteClassAlias();
        operation = new mx.rpc.remoting.Operation(null, "getValoresDominioProcedatos");
		 operation.resultElementType = valueObjects.DominiosAux;
        operations["getValoresDominioProcedatos"] = operation;
        ...
        operation = new mx.rpc.remoting.Operation(null, "getValoresDominioByAbbreviation");
		 operation.resultElementType = valueObjects.Dominios;
        operations["getValoresDominioByAbbreviation"] = operation;

        valueObjects.Dominios._initRemoteClassAlias();
    
        _serviceControl.operations = operations;   
		_serviceControl.convertResultHandler = com.adobe.serializers.utility.TypeUtility.convertResultHandler;
		destination = "DominiosAuxDao";
	...
	/**
	  ...
	  */          
	public function getValoresDominio(arg0:String) : mx.rpc.AsyncToken
	{
	...
	/**
	  * This method is a generated wrapper used to call the 'getValoresDescLiquidacion' operation. It returns an mx.rpc.AsyncToken whose 
	  * result property will be populated with the result of the operation when the server response is received. 
	  * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
	  * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function getValoresDescLiquidacion(arg0:String, arg1:String) : mx.rpc.AsyncToken
	{
		var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getValoresDescLiquidacion");
	...
	/**
	  * This method is a generated wrapper used to call the 'getValoresDominioProcedatos' operation. It returns an mx.rpc.AsyncToken whose 
	  * result property will be populated with the result of the operation when the server response is received. 
	  * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
	  * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function getValoresDominioProcedatos(arg0:valueObjects.DominiosAux) : mx.rpc.AsyncToken
	{
		var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getValoresDominioProcedatos");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
	...
	/**
	  * This method is a generated wrapper used to call the 'getValoresDominioByAbbreviation' operation. It returns an mx.rpc.AsyncToken whose 
	  * result property will be populated with the result of the operation when the server response is received. 
	  * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
	  * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function getValoresDominioByAbbreviation(arg0:String, arg1:String) : mx.rpc.AsyncToken
	{
		var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getValoresDominioByAbbreviation");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0,arg1) ;
