 ...
 * of this service wrapper you may modify the generated sub-class of this class - LiquidacionTotalService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_LiquidacionTotalService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_LiquidacionTotalService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "update");
         operation.resultType = valueObjects.LiquidacionAvaluoTotal;
        ...
        destination = "LiquidacionTotalService";
    ...
    /**
      ...
      */
    public function update(arg0:valueObjects.LiquidacionAvaluoTotal) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function create(arg0:valueObjects.LiquidacionAvaluoTotal) : mx.rpc.AsyncToken
    {
