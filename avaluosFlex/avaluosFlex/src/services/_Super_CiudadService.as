 ...
 * of this service wrapper you may modify the generated sub-class of this class - CiudadService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_CiudadService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_CiudadService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "actualizaCiudad");
        operations["actualizaCiudad"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "persist");
        operations["persist"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "borraCiudad");
        operations["borraCiudad"] = operation;
        ...
        operation = new mx.rpc.remoting.Operation(null, "insertaCiudad");
        operations["insertaCiudad"] = operation;
    ...
    /**
      * This method is a generated wrapper used to call the 'actualizaCiudad' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function actualizaCiudad(arg0:valueObjects.Ciudad) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("actualizaCiudad");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
    ...
    /**
      * This method is a generated wrapper used to call the 'borraCiudad' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function borraCiudad(arg0:valueObjects.Ciudad) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("borraCiudad");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
    ...
    /**
      * This method is a generated wrapper used to call the 'insertaCiudad' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function insertaCiudad(arg0:valueObjects.Ciudad) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("insertaCiudad");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
