 ...
 * of this service wrapper you may modify the generated sub-class of this class - PeritosEmpresaService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_PeritosEmpresaService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_PeritosEmpresaService()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.PeritosEmpresa._initRemoteClassAlias();

        var operations:Object = new Object();
        var operation:mx.rpc.remoting.Operation;

        operation = new mx.rpc.remoting.Operation(null, "consultaUsuarios");
         operation.resultElementType = valueObjects.PeritosEmpresa;
        ...
        operation = new mx.rpc.remoting.Operation(null, "inactivaPeritoEmpresa");
        operations["inactivaPeritoEmpresa"] = operation;
        ...
        operation = new mx.rpc.remoting.Operation(null, "guardaPeritoEmpresa");
        operations["guardaPeritoEmpresa"] = operation;
        ...
        destination = "PeritosEmpresaService";
    ...
    /**
      * This method is a generated wrapper used to call the 'inactivaPeritoEmpresa' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function inactivaPeritoEmpresa(arg0:valueObjects.PeritosEmpresa) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("inactivaPeritoEmpresa");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
    ...
    /**
      * This method is a generated wrapper used to call the 'guardaPeritoEmpresa' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function guardaPeritoEmpresa(arg0:valueObjects.PeritosEmpresa) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("guardaPeritoEmpresa");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
