 ...
 * of this service wrapper you may modify the generated sub-class of this class - InmuebleService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_InmuebleService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_InmuebleService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "create");
         operation.resultType = valueObjects.InformacionInmueble;
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function create(arg0:valueObjects.InformacionInmueble) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function update(arg0:valueObjects.InformacionInmueble) : mx.rpc.AsyncToken
    {
