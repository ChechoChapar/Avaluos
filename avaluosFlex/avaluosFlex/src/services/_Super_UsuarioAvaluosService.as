 ...
 * of this service wrapper you may modify the generated sub-class of this class - UsuarioAvaluosService.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_UsuarioAvaluosService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_UsuarioAvaluosService()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.UsuarioAvaluo._initRemoteClassAlias();

        var operations:Object = new Object();
        var operation:mx.rpc.remoting.Operation;

        operation = new mx.rpc.remoting.Operation(null, "consultaUsuarios");
         operation.resultElementType = valueObjects.UsuarioAvaluo;
        operations["consultaUsuarios"] = operation;
        ...
        operation = new mx.rpc.remoting.Operation(null, "consultaPerito");
         operation.resultType = String;
        operations["consultaPerito"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "consultaPeritoEmpresa");
         operation.resultType = String;
        operations["consultaPeritoEmpresa"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "consultaTodosUsuarios");
         operation.resultElementType = valueObjects.UsuarioAvaluo;
        operations["consultaTodosUsuarios"] = operation;

        _serviceControl.operations = operations;
        _serviceControl.convertResultHandler = com.adobe.serializers.utility.TypeUtility.convertResultHandler;
        destination = "UsuarioAvaluosService";
    ...
    /**
      * This method is a generated wrapper used to call the 'consultaUsuarios' operation. It returns an mx.rpc.AsyncToken whose 
      ...
      */
    public function consultaUsuarios() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("consultaUsuarios");
    ...
    /**
      * This method is a generated wrapper used to call the 'consultaPerito' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function consultaPerito(arg0:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("consultaPerito");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
    ...
    /**
      * This method is a generated wrapper used to call the 'consultaPeritoEmpresa' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function consultaPeritoEmpresa(arg0:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("consultaPeritoEmpresa");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
    ...
    /**
      * This method is a generated wrapper used to call the 'consultaTodosUsuarios' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function consultaTodosUsuarios() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("consultaTodosUsuarios");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send() ;
