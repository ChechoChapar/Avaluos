...
[ExcludeClass]
internal class _CiudadEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
	private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("ciudad", "codAsobancaria", "usuarioTransaccion", "departamento", "idCiudad", "fechaCreacion", "codDane", "fechaTransaccion", "usuarioCreacion");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("ciudad", "codAsobancaria", "usuarioTransaccion", "departamento", "idCiudad", "fechaCreacion", "codDane", "fechaTransaccion", "usuarioCreacion");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("ciudad", "codAsobancaria", "usuarioTransaccion", "departamento", "idCiudad", "fechaCreacion", "codDane", "fechaTransaccion", "usuarioCreacion");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("ciudad", "codAsobancaria", "usuarioTransaccion", "departamento", "idCiudad", "fechaCreacion", "codDane", "fechaTransaccion", "usuarioCreacion");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;    
    model_internal static var entityName:String = "Ciudad";
    model_internal static var dependentsOnMap:Object;    
    model_internal static var dependedOnServices:Array =  new Array();
    
    
    model_internal var _instance:_Super_Ciudad;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();
    
    public function _CiudadEntityMetadata(ciudad : _Super_Ciudad)
    {
        ...
        model_internal::_instance = ciudad;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Ciudad");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Ciudad");  
     ...
     override public function getValue(propertyName:String):*    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity Ciudad");
         }     
